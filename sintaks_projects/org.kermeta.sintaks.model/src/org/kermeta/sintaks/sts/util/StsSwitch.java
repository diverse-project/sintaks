 ...
 * </copyright>
 *
 * $Id: StsSwitch.java,v 1.1 2007-06-14 08:57:31 dtouzet Exp $
 */
...
public class StsSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StsPackage.ALTERNATIVE: {
				...
				if (result == null) result = caseChoice(alternative);
				if (result == null) result = caseRule(alternative);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StsPackage.ONCE: {
				Once once = (Once)theEObject;
				Object result = caseOnce(once);
				if (result == null) result = caseChoice(once);
				if (result == null) result = caseRule(once);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Once</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Once</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
