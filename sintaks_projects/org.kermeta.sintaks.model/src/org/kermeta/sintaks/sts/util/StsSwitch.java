 ...
 * </copyright>
 *
 * $Id: StsSwitch.java,v 1.2 2007-07-24 12:12:18 cfaucher Exp $
 */
...
public class StsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StsPackage.POLYMORPHIC_COND: {
				...
				T result = casePolymorphicCond(polymorphicCond);
			...
			case StsPackage.CUSTOM_COND: {
				...
				T result = caseCustomCond(customCond);
			...
			case StsPackage.URI_VALUE: {
				...
				T result = caseURIValue(uriValue);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Polymorphic Cond</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Polymorphic Cond</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePolymorphicCond(PolymorphicCond object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Custom Cond</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Custom Cond</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCustomCond(CustomCond object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>URI Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>URI Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseURIValue(URIValue object) {
		return null;
	}
