/*$Id: SintaksModelSelectionDialog.java,v 1.1 2007-07-06 13:23:33 dtouzet Exp $
...
public class SintaksModelSelectionDialog extends ResourceSelectionDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		IExtensionPoint extension = Platform.getExtensionRegistry().getExtensionPoint( "org.kermeta.sintaks.stsFilesRegistration" );
		...
		for ( int i=0; i<extensions.length; i++) {
			...
			for ( int j=0; j<elements.length; j++ ) {
				...
				String filePath = "platform:/plugin/" + extensions[i].getContributor().getName() + "/" + file;
