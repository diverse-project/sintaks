 ...
 * </copyright>
 *
 * $Id: TraceSwitch.java,v 1.1 2008-07-21 13:10:33 hassen Exp $
 */
...
public class TraceSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TracePackage.REFERENCE: {
				Reference reference = (Reference)theEObject;
				T result = caseReference(reference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TracePackage.TEXT_REFERENCE: {
			...
			case TracePackage.MODEL_REFERENCE: {
			...
			case TracePackage.FILE_REFERENCE: {
