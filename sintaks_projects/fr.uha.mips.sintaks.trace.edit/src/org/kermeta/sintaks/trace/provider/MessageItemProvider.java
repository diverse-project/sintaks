 ...
 * </copyright>
 *
 * $Id: MessageItemProvider.java,v 1.1 2008-07-21 13:12:04 hassen Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.kermeta.sintaks.trace.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_text_feature", "_UI_Message_type"),
				 TracePackage.Literals.MESSAGE__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Message)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Message.class)) {
			case TracePackage.MESSAGE__TEXT:
